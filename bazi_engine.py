...
def _build_analysis(
    ...
    if "正官" in ten_god_names and "偏印" in ten_god_names:
        personality = "外在气质多半显得稳、清醒、有分寸。盘里先判断后靠近的倾向明显，所以给人的感觉常常比实际年纪更沉着。"
    elif "正官" in ten_god_names or "七杀" in ten_god_names:
        personality = "外在给人的印象往往是靠谱、能扛事、有边界。命盘里责任感偏重，所以气场天然带着一点主心骨。"
    elif "食神" in ten_god_names or "伤官" in ten_god_names:
        personality = "外在气息会更鲜活一些，表达欲和主见都不弱，情绪和立场也更容易被人看见。"
    elif "偏印" in ten_god_names or "正印" in ten_god_names:
        personality = "外在更偏安静、克制，不会一下子把全部情绪摊开。熟悉之后，细腻和分寸感会慢慢显出来。"
    else:
        personality = "这张盘不属特别外放的路数，更像先看气氛、先感受，再决定是否真正投入。"

    if "正官" in ten_god_names and "偏印" in ten_god_names:
        relationship_style = "亲密关系里，真正看重的是确定感与长期性。不是没有情感，而是很少被一时热烈带走，往往先看对方稳不稳、真不真、能不能长期相处。真正在意时，投入会很认真，只是委屈和担心也容易先往心里收。"
    elif "正官" in ten_god_names:
        relationship_style = "亲密关系里更看重稳定、靠谱和长期性。比起热烈开场，命盘更在意的是关系能不能持续给出安全感。"
    elif "偏财" in ten_god_names or "正财" in ten_god_names:
        relationship_style = "亲密关系里很看重投入感。不是没有热情，而是会先判断这段关系值不值得认真交付。"
    elif "偏印" in ten_god_names:
        relationship_style = "亲密关系里需要自己的空间和节奏，不太会一下子把全部情绪讲出来。所以表面看着慢，实则是在确认能不能放心靠近。"
    else:
        relationship_style = "这张盘对关系的判断并不轻率，通常先要觉得舒服、踏实，才会慢慢交出真心。"

    if current_dayun:
        career_text = f"现在走到 {dayun_text} 这一步，更适合把注意力放在长期积累和现实落地上。能慢慢做深、做稳的事，比短期起伏更合这张盘。"
    else:
        career_text = "这张盘更适合走稳扎稳打的节奏，先把基础打牢，再去争取更大的空间，会比急着求结果更顺。"

    annual_text = f"未来 {horizon} 年里，比较适合把注意力放在节奏变化和机会窗口上。先看什么时候该推进、什么时候该稳住，比急着分吉凶更有帮助。"

    if "正官" in ten_god_names and "偏印" in ten_god_names:
        burnout_text = "最容易内耗的地方，是明明已经很想做好，却还担心不够稳。很多时候不是能力不够，而是出手前先把各种可能性都想了一遍，所以压力总会更早落到心里。"
        security_text = "最需要的不是热闹型的喜欢，而是确定感。关系里说话算数、情绪稳定、愿意给回应，防备心才会慢慢放下。"
        change_text = "接下来两三年，最容易发生变化的领域，是工作节奏、现实安排，以及关系边界的判断。很多事会把命盘从“先扛着”推向“该认真选方向了”。"
    elif "正官" in ten_god_names or "七杀" in ten_god_names:
        burnout_text = "容易内耗的时候，多半是责任感太重的时候。很多事外界未必要求满分，命盘自己却会先把标准提上去。"
        security_text = "最需要的是可靠和稳定。只有关系里有秩序、有回应，这张盘才会真正放松。"
        change_text = "接下来两三年最容易变化的，多半是工作压力、身份定位，以及对未来安排的想法。"
    elif "偏印" in ten_god_names or "正印" in ten_god_names:
        burnout_text = "容易内耗的时候，多半是想太多、感受太多的时候。很多话不是没有，只是会先放在心里反复确认。"
        security_text = "最需要的关系安全感，是被理解、被尊重节奏，而不是被催着立刻表态。"
        change_text = "接下来两三年更容易变化的，是内在想法、人际边界，以及想把生活过成什么样。"
    else:
        burnout_text = "容易内耗的时候，多半是在反复权衡、迟迟不想随便决定的时候。不是优柔寡断，而是真的会认真考虑后果。"
        security_text = "最需要的安全感，是相处舒服、没有太多消耗，也不用一直猜来猜去。"
        change_text = "接下来两三年比较容易变化的，是生活节奏和真正愿意投入的方向。"

    return {
        "overview": f"日主为{day_master['stem']}{day_master['element']}，这张盘目前看是{day_master['pattern']}，整体底色偏向{geju['label']}。最明显的主题落在{ten_god_text}，所以这不是一张轻飘飘的盘，很多力量都会在后面的阶段里慢慢显出来。",
        "career": career_text,
        ...
        "annual": annual_text,
        "healing": f"《滴天髓》里说，理乘气行岂有常。放到这张盘上，底色最明显的是 {dominant_element} 的气偏重，所以许多事不会一下子往前冲，而是先落到心里掂量分寸，再慢慢作决定。这不是迟疑，也不是想太多，而是命盘本身更重视稳妥、回应和后劲。很多时候，外面看着只是安静一点、慢一点，里面其实已经把轻重、来回与代价都想过一遍。||眼下容易发紧的地方，往往不是事情本身太难，而是这张盘对后果、边界和稳定度格外敏感。一遇到失衡的节奏，压力就会先收进心里，表面仍想维持平稳，里面却已经开始消耗。也正因为这样，不合适的环境会耗得更快，模糊不清的关系会更累，反而是有回应、有秩序、有分寸感的安排，最能让整个人慢慢松开。||从命盘上看，真正能养这股气的，是 {favorable_text} 这类带来回应、流动与舒展的环境，也是那些能把情绪放稳、把步子放匀的关系与选择。比起逼自己立刻想开、立刻往前冲，这张盘更适合先把日常节奏养顺，把睡眠、情绪、边界和现实安排一点点理平。气一顺，很多原先发紧的地方自然会松。||所以这段路不用急着求一个很重的答案，也不必急着证明什么。先让状态回到舒服的位置，先让心里的秤重新稳下来，再去谈选择和结果，后面的路反而会越走越开。命盘真正怕的不是慢，而是把自己放进不合适的位置里硬撑；只要节奏守住，很多事都会在合适的时候自己显出答案。",
    }
